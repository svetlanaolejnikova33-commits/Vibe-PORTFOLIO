  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(180deg, color-mix(in srgb, var(--color-ink) 35%, var(--color-nubuck)) 0%, var(--color-nubuck) 28%, color-mix(in srgb, var(--color-nubuck) 88%, var(--color-ink) 12%) 100%)',
          boxShadow:
            'inset 0 1px 0 rgba(201,204,209,0.06), inset 0 -1px 0 rgba(0,0,0,0.35), inset 0 0 80px rgba(0,0,0,0.22)',
        }}
      />
      ...
      <div
        ...
        style={{
          transform: reduceMotion ? undefined : `translate3d(${parallax.x}px, ${parallax.y}px, 0)`,
        }}
      >
      ...
      >
        <div
          className={`premium-flow-track flex w-max items-center ${reduceMotion ? 'premium-flow-track--static' : ''}`}
          aria-hidden
        >
