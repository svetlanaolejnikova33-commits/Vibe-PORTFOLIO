...
export function WhyMe() {
  ...
  const smoothFocus = useSpring(focusTarget, {
    stiffness: reduceMotion ? 200 : 52,
    damping: reduceMotion ? 40 : 22,
    mass: reduceMotion ? 0.5 : 0.95,
  })
  ...
  return (
    <section id="why" className="relative px-6 py-28 md:px-12 md:py-32 lg:px-16">
      <div className="mx-auto max-w-5xl">
        ...
        <div
          ref={boardRef}
          className="compare-board relative mt-14 overflow-hidden rounded-none border border-white/[0.09] shadow-depth-md md:mt-16"
          onPointerMove={onPointerMove}
          onPointerLeave={onPointerLeave}
          style={{
            background:
              'linear-gradient(165deg, rgba(42,38,35,0.5) 0%, rgba(15,17,19,0.72) 50%, rgba(22,20,18,0.55) 100%)',
            boxShadow:
              '0 16px 56px rgba(0,0,0,0.45), inset 0 1px 0 rgba(201,204,209,0.08)',
          }}
        >
          <div
            ...
            style={{
              background: `linear-gradient(90deg,
                rgba(111,227,255,${0.03 + leftGlow * 0.07}) 0%,
                rgba(201,204,209,0.035) 42%,
                rgba(111,227,255,${0.04 + rightGlow * 0.09}) 100%)`,
            }}
          />
          <div
          ...
          <div className="relative z-[2] grid grid-cols-1 md:grid-cols-2">
            <div
              ...
              style={{
                opacity: leftOpacity,
                boxShadow: `inset 0 0 72px rgba(111,227,255,${leftGlow * 0.12})`,
              }}
            >
              <div
                style={{
                  transform: `translate3d(${parallaxX * 0.9}px, ${parallaxX * 0.25}px, 0)`,
                  transition: reduceMotion ? undefined : 'transform 0.38s ease-out',
                }}
              >
            ...
            >
              <div
                className="compare-zone compare-zone--right relative px-7 py-10 text-left transition-opacity duration-300 md:px-9 md:py-12"
                style={{
                  opacity: rightOpacity,
                  boxShadow: `inset 0 0 80px rgba(111,227,255,${rightGlow * 0.14})`,
                }}
              >
                <div
                  style={{
              ...
              <motion.div
                className="compare-soft-cta-wrap px-7 pb-9 pt-1 md:px-9 md:pb-10 md:pt-0"
                initial={false}
